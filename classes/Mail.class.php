<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'principal@youcodelove.com';//Trocar e-mail aqui!
		public $senha = 'Eduardorafael0!';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'mail.youcodelove.com'; //SERVIDOR SMTP DA HOSPEDAGEM
